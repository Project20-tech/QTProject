...
class Ui_CGPA(object):
    def setupUi(self, CGPA):
        ...
        CGPA.setPalette(palette)
        CGPA.setToolButtonStyle(QtCore.Qt.ToolButtonIconOnly)
        CGPA.setDocumentMode(False)
        CGPA.setTabShape(QtWidgets.QTabWidget.Rounded)
        CGPA.setDockNestingEnabled(False)
        CGPA.setDockOptions(QtWidgets.QMainWindow.AllowTabbedDocks|QtWidgets.QMainWindow.AnimatedDocks)
        self.centralwidget = QtWidgets.QWidget(CGPA)
        ...
        self.lineEdit_3.setGeometry(QtCore.QRect(110, 10, 61, 20))
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.lineEdit_4 = QtWidgets.QLineEdit(self.groupBox)
        self.lineEdit_4.setEnabled(True)
        self.lineEdit_4.setGeometry(QtCore.QRect(110, 40, 61, 20))
        ...
        CGPA.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(CGPA)
        ...
        CGPA.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(CGPA)
        self.statusbar.setObjectName("statusbar")
        CGPA.setStatusBar(self.statusbar)
        self.menubar.addAction(self.menuGPA.menuAction())
        self.menubar.addAction(self.menuCGPA.menuAction())
        self.menubar.addAction(self.menuHELP.menuAction())
        self.menubar.addAction(self.menuABOUT.menuAction())

        self.retranslateUi(CGPA)
        QtCore.QMetaObject.connectSlotsByName(CGPA)

    def retranslateUi(self, CGPA):
        _translate = QtCore.QCoreApplication.translate
        CGPA.setWindowTitle(_translate("CGPA", "CGPA"))
        self.pushButton.setText(_translate("CGPA", "ADD"))
        self.label.setText(_translate("CGPA", "GRADE"))
        self.label_2.setText(_translate("CGPA", "CREDIT HOURS"))
        self.label_5.setText(_translate("CGPA", "GPA ADDED PREVIEW"))
        self.label_3.setText(_translate("CGPA", "CGPA:"))
        self.label_4.setText(_translate("CGPA", "TOTAL CREDIT HOURS"))
        self.label_6.setText(_translate("CGPA", "CLASS ATTAINED"))
        self.pushButton_2.setText(_translate("CGPA", "NEW"))
        self.pushButton_3.setText(_translate("CGPA", "PushButton"))
        self.pushButton_4.setText(_translate("CGPA", "SCREENSHOT"))
        self.lblTitle.setText(_translate("CGPA", "<html><head/><body><p><span style=\" font-size:16pt; font-weight:400;\">CGPA</span></p></body></html>"))
        self.lblTitle_2.setText(_translate("CGPA", "<html><head/><body><p>CALCULATOR</p></body></html>"))
        self.menuGPA.setTitle(_translate("CGPA", "GPA"))
        self.menuCGPA.setTitle(_translate("CGPA", "CGPA"))
        self.menuHELP.setTitle(_translate("CGPA", "HELP"))
        self.menuABOUT.setTitle(_translate("CGPA", "ABOUT"))
